...
Design and development of automation solutions and scalable scripts to improve operational efficiency. Key achievements include:
...
This position involves designing, developing, and maintaining automation solutions to streamline network operations and improve efficiency, scalability and reliability. My role involves collaborating with cross-functional teams, including network engineers, software developers, and operations teams, to identify areas for automation and develop solutions that enhance the overall network infrastructure.
  ...
  - Development of Python scripts and tools for process automation, batch changes, data collection and analysis.
  - Design and deployment of user-friendly GUIs for internal data workflows.
  - Containerized applications and deployed services in cloud environments (GCP).
  - Automated monitoring and reporting systems (Zabbix) to provide reliable operational insights.
  - Implemented high availability (HA) architectures for critical systems:
  ...
  > Skills highlighted: Python, automation, cloud deployment, Google Cloud Platform (GCP), process optimization.
...
> #### Soft Skills: 
> Problem-solving, process optimization, collaboration with cross-functional teams
...
> Developed an automated content contribution system, enabling distributed users to upload and schedule files efficiently.
